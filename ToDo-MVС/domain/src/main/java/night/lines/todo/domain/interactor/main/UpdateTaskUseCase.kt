...
class UpdateTaskUseCase constructor(private val databaseRepository: DatabaseRepository) : UseCaseWithParameter<Task, Unit> {
    override fun execute(parameter: Task): Observable<Unit> = databaseRepository.updateTask(parameter)
}